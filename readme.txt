1) Format Config. Bot because we have transformed into a server on the pitch. So
...
Bot : able to receive files from the server to write to the vfs and run , can delete files
...
Server: receives from the bot information recorded in the database, receives MasterBot
